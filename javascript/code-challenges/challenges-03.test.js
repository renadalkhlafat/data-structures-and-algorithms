...
const typeNum = (arr) => {
  // Solution code here...
  let NewArray = arr.filter(element => !isNaN(element));
  return NewArray;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let NewArray = arr.filter(element => element.baseStat > minBaseStat);
  return NewArray;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let NewArray = arr.filter(element => element.baseStat >minBaseStat).map(element=>element.stat.name);
  return NewArray;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  let NewArray = arr.filter(element => !element.children);
  return NewArray;
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let NewArray = arr.filter(element => typeof element === 'number').map(element => +element % 2 === 0 ? 'even' : 'odd');
  return NewArray;
};
